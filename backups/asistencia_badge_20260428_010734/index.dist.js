...
async function actualizarEstadoSabadosPeriodo(input) {
  ...
  try {
    ...
    const setSql = input.estado === "asistencia" ? `es_falta = 0, es_descanso = 0, entrada = COALESCE(entrada, 'Asistencia'), salida = COALESCE(salida, '')` : input.estado === "falta" ? `es_falta = 1, es_descanso = 0, entrada = NULL, salida = NULL` : `es_falta = 0, es_descanso = 1, entrada = NULL, salida = NULL`;
