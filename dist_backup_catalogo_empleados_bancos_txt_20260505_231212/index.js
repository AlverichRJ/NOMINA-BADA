...
async function getEmpleados(periodoId, incluirInactivos = false) {
  ...
  const [rows] = await rawConn.execute(`
    ...
    GROUP BY e.id, e.nombre, e.departamento_id, d.nombre, e.notas, e.salario_mensual, e.bonos, e.dias_laborados, e.descuentos_adicionales, e.activo, e.createdAt, e.updatedAt
    ORDER BY e.nombre
